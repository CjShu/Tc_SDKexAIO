namespace Tc_SDKexAIO.Config
{
    ...
    internal static class ExterienceManager
    {
        ...
        public static MenuSliderButton GetSliderButton(this Menu Menu, string name, string display, int cur, int min = 0, int max = 100)
        {
            return Menu.Add(new MenuSliderButton(name, display, cur, min, max) { BValue = true });
        }
    }
}